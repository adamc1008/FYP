...
# Train a logistic regression classifier using the resampled training data
...
joblib.dump(classifier, 'linear_regression_under.pkl')
joblib.dump(vectorizer, 'vectorizer_linear_regression_under.pkl')
